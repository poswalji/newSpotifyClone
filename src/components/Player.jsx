...
const Player = () => {
  const {next,Track,seekBar,seekBg,playStatus,play,pause,time,previous,songseek}=useContext(PlayerContext)
  return (
...
<p>{Track.desc.slice(0,12)}</p>
      ...
      <div className='flex flex-col items-center gap-1 m-auto'>
        ...
        <div className='flex items-center gap-5'>
            ...
            <div ref={seekBg} onClick={songseek}className='w-[60vw] max-w-[500px] bg-gray-300 rounded-full cursor-pointer '>
